<!-- This layout uses Images 185x150px and only shows images with a left sidebar -->
...
<div class="full-middle">
	...
	<div class="main">
		...
		<!-- BEGIN g240 rsidebar -->
		<div class="g240" id="lsidebar" style="width:160px; float:left;">
		...
		<?php $count++; if($count==6){ $var='style="margin-left:0px;"'; $count=0; } else { $var=""; } ?>
		...
		<div class="mosaic-block-lsidebar <?php echo $mosaic; ?>" > 
